...
function respconv=mlhrateeiglingen3c1Ex_G(initparams,LUbounds,frburstdata,cumindex,indexone,fixed, stateid,exid,chans,denatConc,maxThread,GPU_load)
...
respconv=mlhrateeiglingen3c1Ex_CU(initparamsMat,LUboundsMat,frburstdata,cumindex,indexone,cntrate,fixedMat,stateid,exid,denatConc,maxThread,GPU_load);
end